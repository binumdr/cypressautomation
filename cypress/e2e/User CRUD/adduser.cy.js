describe('MyTestSuite', function()
{
    it('usercreatewithallfieldempty', function()
    {
       /*-----login---*/
        ...
        cy.get('.MuiDialogContent-root > :nth-child(1) > .MuiGrid-grid-xs-6 > .MuiFormControl-root > .MuiInputBase-root > #firstName').type('Binu').wait(3000)
        cy.get('.MuiGrid-root.css-13bpl69 > .MuiFormControl-root > .MuiInputBase-root > .MuiInputBase-input').type('Manandhar').wait(2000)
        cy.get('#dob',{timeout:2000}).type('04/24/1999')
        ...
        cy.get(':nth-child(2) > .MuiFormControl-root > .MuiInputBase-root > #phone',{timeout:2000}).type('9841235670')
